  ...
  return (
    <div className='min-h-screen bg-background'>
        ...
        <div className='container flex h-16 items-center justify-between'>
          <div className='flex items-center gap-2'>
            <Button
              ...
              aria-label={
                sidebarOpen
                  ? t('navigation.closeMobileMenu')
                  : t('navigation.openMobileMenu')
              }
          ...
          <div className='flex items-center gap-2'>
            ...
            >
              <a
                href='https://github.com/redeyedev-208/react-shadcn-typescript-a11y-tanstack-refresher'
                target='_blank'
      ...
      <div className='flex'>
        ...
        <aside
          id='mobile-sidebar'
          className={`fixed inset-y-0 left-0 z-40 w-64 bg-background border-r transform transition-transform duration-200 ease-in-out md:relative md:translate-x-0 ${
        ...
        <main className='flex-1 p-6 space-y-12'>
                  ...
                  <CardContent className='space-y-4'>
                    <div className='flex flex-wrap gap-2'>
                      ...
                      <Button variant='destructive'>
                        {t('showcase.buttons.destructive')}
                      </Button>
                    </div>
                    <div className='flex flex-wrap gap-2'>
                      <Button size='sm'>{t('showcase.buttons.small')}</Button>
                      <Button size='default'>
                        {t('showcase.buttons.default')}
                      </Button>
          ...
          >
            <div className='text-center space-y-4'>
              ...
              <p className='text-muted-foreground max-w-2xl mx-auto'>
                Created to establish patterns for Accessibility Champions
                Programs in organizations, providing tools and knowledge for
                inclusive design.
              </p>
            </div>
